...
object TestDependencies {
    ...
    const val mockWebServer = "com.squareup.okhttp3:mockwebserver:${Versions.httpLoggingInterceptorVersion}"
    const val idlingResources = "com.jakewharton.espresso:okhttp3-idling-resource:${Versions.idlingResourceVersion}"
